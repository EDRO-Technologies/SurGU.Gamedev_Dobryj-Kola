...
{
    //propeller
    public PropellerRotator propellerFR;
    public PropellerRotator propellerFL;
    public PropellerRotator propellerBL;
    public PropellerRotator propellerBR;
    ...
    void AddControls()
    {
        _targetHeight += _inputs.Throttle;
    ...
    void AddMotorForce()
    {
        ...
        _visualizer.Visualize(propellerForceFR, propellerForceFL, propellerForceBL, propellerForceBR, _inputs.EnbleVisual);
